@extends('layouts.admin')
   ...
   <div class="loader"></div>
    ...
    <!-- Floristy Begin -->
    @section   <div class="Floristy__menu__overlay"></div>
    <div class="Floristy__menu__wrapper">
        ...
        <div class="Floristy__menu__contact">
            <ul>
                <li><i class="fa fa-envelope"></i>Email:Floristy@shop.com</li>
    ...
    <!-- Hero Section Begin -->
    @section  <section class="hero hero-normal">
        <div class="container">
            <div class="row">
                <div class="col-lg-3">
    ...
    @section <section class="breadcrumb-section set-bg" data-setbg="img/flowers.jpg">
        <div class="container">
            <div class="row">
    ...
    @section <section class="contact spad">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 text-center">
                    <div class="contact__widget">
                        ...
                        <h4>Address</h4>
                        <p>20alramal station mahmoud fahmi</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-6 text-center">
                    <div class="contact__widget">
    ...
    @section  <div class="map">
        ...
        <div class="map-inside">
            ...
            <div class="inside-widget">
                <h4>alexandria</h4>
                <ul>
                    <li>Phone:01271365336 </li>
                    <li>Add: 20 alramel station mahmoud azmi st</li>
                </ul>
            </div>
        </div>
        @endsection  </div>
    ...
    <!-- Contact Form Begin -->
    @section <div class="contact-form spad">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
