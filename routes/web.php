...
Route::get('/Aboutus',[\App\Http\Controllers\AboutusController::class,'show'])->name('Aboutus');
...
// Route::get('Aboutus', [\App\Http\Controllers\AboutusController::class, 'getAboutus']);
// ongkir
